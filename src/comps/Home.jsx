...
import logoImg from "../assets/images/books.png";
import heroImg from "../assets/art/website.png";
import { addNewUser, loginUser } from "../utils/fetchData";

import feature_two from "../assets/art/notebook.png";
import feature_one from "../assets/art/efficiency.png";
import feature_three from "../assets/art/arcade-game.png";
      ...
      <section id="signup" className="sign-up">
        ...
        <div class="card">
          <div class="header">
            ...
            >
              <path
                id="fa3b9e12-7275-481e-bee9-64fd9595a50d-100"
                data-name="Path 1"
              ...
              />
              <path
                id="bde08021-c30f-4979-a9d8-cb90b72b5ca2-101"
                data-name="Path 2"
              ...
              />
              <path
                id="b3ac2088-de9b-4f7f-bc99-0ed9705c1a9d-102"
                data-name="Path 22"
              ...
              />
              <path
                id="b2715b96-3117-487c-acc0-20904544b5b7-103"
                data-name="Path 23"
              ...
              />
              <path
                id="b06d66ec-6c84-45dd-8c27-1263a6253192-104"
                data-name="Path 6"
              ...
              />
              <path
                id="e73810fe-4cf4-40cc-8c7c-ca544ce30bd4-105"
                data-name="Path 7"
              ...
              />
              <path
                id="bbe451c3-febc-41ba-8083-4c8307a2e73e-106"
                data-name="Path 8"
              ...
              />
              <path
                id="ae7af94f-88d7-4204-9f07-e3651de85c05-108"
                data-name="Path 99"
              ...
              />
              <path
                id="a6768b0e-63d0-4b31-8462-9b2e0b00f0fd-109"
                data-name="Path 101"
              ...
              />
              <path
                id="bfd7963f-0cf8-4885-9d3a-2c00bccda2e3-110"
                data-name="Path 102"
